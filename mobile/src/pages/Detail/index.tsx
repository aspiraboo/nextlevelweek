...
const Detail = () => {
  ...
  const routeParams = route.params as Params; // já define o formato
  ...
  function handleTelegram() {
      // Linking.openURL(`whatsapp://send?phone=48999999999&text=${message}`);
      // Linking.openURL(`tg://resolve?domain=aspiraboo&msg=${message}`);
      ...
      Linking.openURL(`tg://msg?text=hohohoh`);
  }
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      <View style={styles.footer}>      
        <RectButton style={styles.button} onPress={handleTelegram}>
