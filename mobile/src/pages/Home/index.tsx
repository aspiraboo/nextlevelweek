...
const Home = () => {
  ...
  const [ufs, setUfs] = useState<IBGEUFResponseRNP[]>([]);
  const [selectedUf, setSelectedUf] = useState('0');

  const [cities, setCities] = useState<IBGECityResponseRNP[]>([]);
